...
if __name__ == '__main__':
    ...
    for subj in range(6,9):
        for func in range(1,3):
            ...
            result = pool.starmap_async(outer, zip(vts,[pool]*len(vts)))
            result.get() # or result.wait()
    pool.close() 

(complexity) PS C:\Users\Mango\Documents\Complexity\Midterm_Project\analysis> python .\corr_msc_w_local_pool_v2.3.py
Now running subject 6, session 1
Initializing pool...
Traceback (most recent call last):
  File "C:\Users\Mango\Documents\Complexity\Midterm_Project\analysis\corr_msc_w_local_pool_v2.3.py", line 47, in <module>
    result.get() # or result.wait()
