...
if __name__ == '__main__':
    ...
    for subj in range(6,9):
        for func in range(1,3):
            ...
            pool.starmap(outer, list(zip(vts[:5],pool))) # convert zip object to list
            pool.close()

(complexity) PS C:\Users\Mango\Documents\Complexity\Midterm_Project\analysis> python .\corr_msc_w_local_pool_v2.6.py
Now running subject 6, session 1
Initializing pool...
Traceback (most recent call last):
  File "C:\Users\Mango\Documents\Complexity\Midterm_Project\analysis\corr_msc_w_local_pool_v2.6.py", line 41, in <module>
    pool.starmap(outer, list(zip(vts[:5],pool))) # convert zip object to list
